<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
      ...
      <el-form-item label="测试键名" prop="testKey">
        <el-input
    ...
    <el-table v-loading="loading" :data="testList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="测试编号" prop="testId" width="120" />
      <el-table-column label="测试名称" prop="testName" :show-overflow-tooltip="true" width="150" />
      <el-table-column label="测试键名" prop="testKey" :show-overflow-tooltip="true" width="150" />
      <el-table-column label="测试内容" prop="testValue" :show-overflow-tooltip="true" width="200" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="测试键名" prop="testKey">
          <el-input v-model="form.testKey" placeholder="请输入测试键名" />
        </el-form-item>
        <el-form-item label="测试内容" prop="testValue">
          <el-input v-model="form.testValue" placeholder="请输入测试内容" />
        </el-form-item>
        <el-form-item label="状态" prop="status">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        testKey: [
          { required: true, message: "测试键名不能为空", trigger: "blur" }
        ],
        status: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除测试编号为"' + testIds + '"的数据项？').then(function() {
